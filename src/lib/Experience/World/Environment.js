...
export default class Environment {
    ...
    idleFog() {
        ...
        gsap.to(this.fog.instance.color, {
            duration: 1.5,
            r: 0x7a / 255, g: 0x8e / 255, b: 0x99 / 255, // Target color is #7a8e99
            ease: "power2.inOut",
            onUpdate: () => {
                // Update the fog color during the animation
                this.fog.instance.color.setRGB(this.fog.instance.color.r, this.fog.instance.color.g, this.fog.instance.color.b);
            }
        });
    }
    ...
    artworkFog() {
        ...
        gsap.to(this.fog.instance.color, {
            duration: 1.5,
            r: 0, g: 0, b: 0, // Target color is black
            ease: "power2.inOut",
            onUpdate: () => {
                // Update the fog color during the animation
                this.fog.instance.color.setRGB(this.fog.instance.color.r, this.fog.instance.color.g, this.fog.instance.color.b);
