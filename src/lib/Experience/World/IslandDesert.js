...
export default class IslandDesert {
	constructor() {
		...
		if (this.debug.active) {
			...
			positions.islandDesert.artwork11.position
			...
			positions.islandDesert.artwork12.position
			...
			positions.islandDesert.artwork13.position
			...
			positions.islandDesert.artwork14.position
			...
			positions.islandDesert.artwork15.position
	...
	setModel() {
		this.model.position.set(
			positions.islandDesert.position.x,
			positions.islandDesert.position.y,
			positions.islandDesert.position.z
		);
	...
	setMaterial() {
		...
		this.model.traverse((child) => {
			if (
				(child.isMesh && child.name === 'island-desert') ||
				(child.isMesh && child.name === 'portal-desert')
			) {
	...
	addArtworks() {
		...
		this.artworks.push(
			artwork11.artworkMesh,
			artwork12.artworkMesh,
			artwork13.artworkMesh,
			artwork14.artworkMesh,
			artwork15.artworkMesh
		);
