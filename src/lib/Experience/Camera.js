...
export default class Camera {
    ...
    setInstance() {
        ...
        this.instance = new THREE.PerspectiveCamera(fov, this.sizes.width / this.sizes.height, 0.1, 200);
        ...
        if (!value.includes('artwork')) {
            ...
            if (value == "idle") {
                ...
                if(this.instance.aspect > 1){
                    ...
                    gsap.to(this.instance.position, { duration: 2, x: 0., y: 4.0, z: 12.0, ease: "power2.inOut" });                
                }
